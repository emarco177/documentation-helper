...
embeddings = GoogleGenerativeAIEmbeddings(
    ...
    # LangChain uses batch_size instead of chunk_size for embeddings
    batch_size=50, 
)
...
async def main():
    ...
    log_header("Document ingestion pipeline started....")

    log_info("TavilyCrawl: Starting crawl documentation from https://python.langchain.com", Colors.PURPLE)
